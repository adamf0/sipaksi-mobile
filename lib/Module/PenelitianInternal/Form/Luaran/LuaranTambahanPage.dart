...
import 'package:sipaksi/Module/PenelitianInternal/Form/Luaran/Provider/LoadingSaveLuaranTambahanState.dart';
...
class LuaranTambahanPage extends StatefulWidget {
  const LuaranTambahanPage({super.key});

  @override
  State<LuaranTambahanPage> createState() => _LuaranTambahanPageState();
}

class _LuaranTambahanPageState extends State<LuaranTambahanPage> {
  @override
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (context) => LoadingSaveLuaranTambahanState(),
      child: Scaffold(
        appBar: AppBar(
          leading: LayoutBuilder(
            builder: (context, constraints) {
              final loadingState =
                  Provider.of<LoadingSaveLuaranTambahanState>(context);
...
class _ContentState extends State<Content> {
  ...
  Widget build(BuildContext context) {
    ...
    final loadingState = Provider.of<LoadingSaveLuaranTambahanState>(context);
