...
import 'package:sipaksi/Module/PenelitianInternal/Form/Luaran/Form/Provider/LoadingSaveLuaranTambahanFormState.dart';
...
class LuaranTambahanFormPage extends StatefulWidget {
  const LuaranTambahanFormPage({super.key});

  @override
  State<LuaranTambahanFormPage> createState() => _LuaranTambahanFormPageState();
}

class _LuaranTambahanFormPageState extends State<LuaranTambahanFormPage> {
  @override
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (context) => LoadingSaveLuaranTambahanFormState(),
      child: Scaffold(
        appBar: AppBar(
          leading: LayoutBuilder(
            builder: (context, constraints) {
              final loadingState =
                  Provider.of<LoadingSaveLuaranTambahanFormState>(context);
